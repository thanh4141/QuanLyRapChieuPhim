...
    @MatKhau NVARCHAR(MAX),   -- Mật khẩu HASHED
...
ALTER PROCEDURE sp_UpdateUserPassword
    @UserId NVARCHAR(50), 
    @MatKhau NVARCHAR(MAX) -- PHẢI LÀ NVARCHAR(MAX)
AS
BEGIN
    UPDATE Users
    SET 
    ...
    -- Đây là lý do code C# của bạn trả về 500: ExecuteNonQueryAsync trả về 0 nếu không có dòng nào bị ảnh hưởng.
    SELECT @@ROWCOUNT; 
END
